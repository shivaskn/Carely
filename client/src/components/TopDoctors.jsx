...
const TopDoctors = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my- text-gray-900 md:mx-10'> {/*in this div i have stored two elements which is h1 and p tag.*/}
         ...
         <div className='w-full grid grid-cols-auto gap-5 pt-5 gap-y-6 px-3 sm:px-0'> {/*In this section i have used map function and grid for responsiveness and also slice method to display only 10 doctors*/}
